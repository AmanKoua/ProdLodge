...
const PeakModule = ({
  ...
  const handleGainSliderChange = (event: any) => {
    let tempData = data;
    tempData.gain = event.target.value;
    editAudioNodeData(data, position);
  };
  ...
  return (
    <div className=" w-4/12 h-full ml-1 mr-1 rounded-md border-gray-400 border-r-2 border-l-2 border-t-2 border-b-2 shadow-sm">
      <div className=" w-10/12 h-full ml-auto mr-auto pt-1 overflow-y-scroll hide-scrollbar ">
        ...
        <h1 className="text-xl w-max mr-auto ml-auto">Peak</h1>
        ...
        <br></br>
        <div className=" w-10/12 h-1/6 mr-auto ml-auto pb-2 flex justify-between">
          <div
